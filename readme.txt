...
is to troubleshoot the queries of the user Regarding the Saas/IT application issues.

Prerequisites & Requirements:
operating system: Windows 11
programming language: python-3.14
Developer tool: VScode
LLM Models: Gemini (gemini-3.5-flash/gemini-3.6-flash)
Embedding Model: gemini-embedding-2
vector database: Faiss
frontend framework: streamlit
Deployed tools: github,streamlit community cloud
